...
const ModalDenyReception = props => {
  ...
  return (
    ...
    >
      <div className="ant-modal-body-center">
        ...
        >
          <Form.Item
            label="Vui lòng nhập lý do từ chối tiếp nhận Hồ sơ/Tài liệu:"
            name="Content"
            required
...
ModalDenyReception.defaultProps = {
  width: 620,
  className: 'atbd-modal'
}

ModalDenyReception.propTypes = {
