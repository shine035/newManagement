...
const ModalApproveTicket = props => {
  ...
  return (
    ...
    >
      ...
      <p>
        Bạn đồng ý duyệt phiếu <b>{data?.TicketNo}</b> của độc giả: <b>{data?.FullName || data?.CreateUser}</b>?
      </p>
    </ModalWrapper>
  )
}

ModalApproveTicket.defaultProps = {
  width: 620,
  className: 'atbd-modal'
}

ModalApproveTicket.propTypes = {
